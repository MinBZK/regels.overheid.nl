...
1. Zaakgebaseerde methoden (_case-based_),
2. Regelgebaseerde methoden (_rule-based_),
3. Deontische logica (_deontic logic_),
4. Modelgerichte methoden (_modelling_).
...
# Zaakgebaseerde methoden (_case-based_)
...
# Regelgebaseerde methoden (_rule-based_)
...
# Deontische logica (_logics approach_)
...
# Modelgerichte methoden (_modelling approach_)
