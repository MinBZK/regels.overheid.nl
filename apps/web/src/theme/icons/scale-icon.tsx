...
export const ScaleIcon: React.FC<SvgIconProps> = (props) => (
  <SvgIcon viewBox="0 0 109 107" {...props}>
    <path d="M32.2085 89.46H76.7918" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M27.75 27.0433L54.5 22.585L81.25 27.0433" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M54.5 13.6685V89.4601" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
    <path
