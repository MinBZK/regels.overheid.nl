...
export const ScaleIcon: React.FC<SvgIconProps> = (props) => (
  <SvgIcon viewBox="0 0 109 107" {...props}>
    <path d="M32.2085 89.46H76.7918" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
    <path
    ...
    />
    <path d="M54.5 13.6685V89.4601" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
    <path
