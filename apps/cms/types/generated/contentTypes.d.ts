...
export interface ApiApplicationMetadataApplicationMetadata extends Schema.SingleType {
  collectionName: 'application_metadatas';
  info: {
    singularName: 'application-metadata';
    pluralName: 'application-metadatas';
  ...
  attributes: {
    ...
    versionUpdatedAt: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::application-metadata.application-metadata', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::application-metadata.application-metadata', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiBlogArticleBlogArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<
      ['Voorbeeld', 'Demonstratie', 'Methode', 'Wetsanalyse', 'Uitlegbaarheid', 'Bestuur', 'Architectuur']
    > &
      Attribute.Required;
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::blog-article.blog-article', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::blog-article.blog-article', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
...
export interface ApiMethodMethod extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Icon: Attribute.Enumeration<['arch', 'megaphone', 'right-angle-ruler', 'ruler', 'scale', 'therefore']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    Tag: Attribute.Enumeration<['platform', 'software', 'DSL', 'methode']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::method.method', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::method.method', 'oneToOne', 'admin::user'> & Attribute.Private;
    localizations: Attribute.Relation<'api::method.method', 'oneToMany', 'api::method.method'>;
    locale: Attribute.String;
  };
}
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cmsPage: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>;
    showInNav: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPublisherPublisher extends Schema.CollectionType {
  ...
  attributes: {
    ...
    repo: Attribute.String & Attribute.Required;
    secret: Attribute.String & Attribute.Required & Attribute.Private;
    name: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
